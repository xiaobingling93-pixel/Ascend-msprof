...
class TestAscendMsprofAppSampleBasedArithmeticUtilization(BaseAscendMsprofChecker):
    def check_ai_vector_core_utilization_data(self):
        ...
        FileChecker.check_csv_data_non_negative(ai_vector_core_utilization_path[0],
                                                ...
                                                columns=["mac_fp16_ratio", "mac_int8_ratio",
                                                         "vec_fp32_ratio", "vec_fp16_ratio", "vec_int32_ratio",
                                                         "vec_misc_ratio", "cube_fops",
                                                         "vector_fops"])
...
def test_ascend_msprof_app_sample_based_arithmetic_utilization(prof_path):
    expect_db_tables = ["ACC_PMU", "AICORE_FREQ", "CANN_API", "COMPUTE_TASK_INFO", "ENUM_API_TYPE",
                        ...
                        "STRING_IDS", "TASK"]
    test_ascend_msprof = TestAscendMsprofAppSampleBasedArithmeticUtilization(prof_path, expect_db_tables)
